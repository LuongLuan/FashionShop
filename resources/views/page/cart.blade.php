                            ...
                            <div class="table-responsive-md">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <a href="{{route('del-product',$row->rowId)}}" class="remove" d-id="{{$row->rowId}}" >
                        ...
                        <div class="cart_totals_area">
                            ...
                            <div class="total_amount row m0 row_disable">
                                ...
                                <div class="float-right">
                                    <span id="cart-total">{{Cart::total()}} Đ</span>
                                </div>
                            </div>
                        </div>
...
<div class="container">
    <div class="related_product_inner">
        ...
        <?php $product = DB::table('product')->inRandomOrder()->paginate(4); ?>
        <div class="row">
