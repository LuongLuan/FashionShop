        ...
        <div class="col-lg-9 float-md-right">
          <div class="showing_fillter">
            <div class="alert alert-info">
              <h4>{{$_scate->Name}} <span style="font-size: 15px">(<b style="color: red">{{count($c_getpro_sub)}}</b> sản phẩm)</span>  <hr>
              ...
              <form class="form-inline" style="float:right;margin-top: -80px;" action="" method="get">
                <div class="form-group">
                  <label for="sel1">Lọc theo &nbsp;</label>
                  <select style="font-size: 15px" class="form-control input-sm" id="order" name="order" onchange="OrderProduct({{$_scate->Id}})">
                  ...
                  window.location = 'danh-muc/Id=' + id + '?order=' + val;
                  }
                  </script>
                </div>
              </form>
          ...
          @if(count($getpro_sub)!= 0)
          <div class="categories_product_area">
            <div class="row">
              @foreach($getpro_sub as $row)
      ...
      <div class="col-lg-3 float-md-right">
        <div class="categories_sidebar">
          <aside class="l_widgest l_fillter_widgett">
            ...
            <form action="{{route('get-product',$idd)}}" method='GET' style='margin-bottom:10px'>
              {{ csrf_field()}}
              ...
              <button style="width: 20px" type="submit" class="btn-filter"><i class="fas fa-caret-right"></i></button><br><br>
              <span class='error' style='color:red'></span>
            </form>
            <div>
              <a href="danh-muc/Id={{$idd}}?minPrice=0&maxPrice=100000" class="btn btn-info">Dưới 100k</a>
              <a href="danh-muc/Id={{$idd}}?minPrice=150000&maxPrice=300000" class="btn btn-info">150k ~ 300k</a><br><br>
              <a href="danh-muc/Id={{$idd}}?minPrice=300000&maxPrice=500000" class="btn btn-info">300k ~ 500k</a>
              <a href="danh-muc/Id={{$idd}}?minPrice=500000&maxPrice=10000000" class="btn btn-info">Trên 500k</a>
            </div>
          </aside>
