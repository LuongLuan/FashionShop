        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav justify-content-end">
                    ...
                    <li class="cart_cartt"><a href="{{route('gio-hang')}}"><i class="icon-handbag icons"></i><span id='count' style="font-size: 17px;color:#d91522;font-weight: normal;">({{Cart::count()}})</span></a></li>
                </ul>
            </div>
        </nav>
    </div>
