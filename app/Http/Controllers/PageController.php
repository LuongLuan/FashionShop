...
class PageController extends Controller
{
    ...
    public function getproCate($id){
        ...
        return view('page.getproduct_cate',compact('get_pCate','subCate','featured'));
    }
    //Lấy sp theo sub chuyên mục
    public function getProduct($id){
        $getpro_sub = product::where('SubCategoryId',$id)->paginate(8);
        return view('page.getproduct',compact('getpro_sub'));
    }
    //Tìm kiếm
